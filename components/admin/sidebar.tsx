    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "max-md:fixed max-md:left-0 max-md:top-0 max-md:z-50 max-md:w-60",
          mobileOpen
      ...
      >
        ...
        <div className="h-14 flex items-center px-4 border-b border-[var(--glass-border)]">
          <Link href="/admin" onClick={handleNavClick} className={cn(
          ...
          <button
            onClick={onClose}
            className="ml-auto p-1 text-[var(--text-muted)] hover:text-white transition-colors md:hidden"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
