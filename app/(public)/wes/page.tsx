...
export const metadata: Metadata = {
  title: "Wes @ Consensus Miami \u00b7 FP Block",
  icons: {
    icon: [
      {
        ...
        <div className="wrap">
          <div className="header-inner">
            ...
            <div className="header-socials">
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/wesleycrook/"
                target="_blank"
                rel="noopener"
                className="icon-link"
                aria-label="Wes on LinkedIn"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <div className="mobile-hero">
              ...
              <div className="hero-identity">
                ...
                <div className="hero-meta">
                  <h1 className="hero-name">Hey, I&apos;m Wes.</h1>
              ...
              <div className="cta-card">
                ...
                <div className="event-details">
                  ...
                  <ul className="event-expect">
                    ...
                    <li>
                      Panel discussion &mdash; I&apos;ll be on stage
                    </li>
